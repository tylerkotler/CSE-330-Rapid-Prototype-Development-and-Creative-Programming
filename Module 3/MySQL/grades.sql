...
| grades | CREATE TABLE `grades` (
  ...
  KEY `grades_ibfk_2` (`course_code`,`dept_id`,`school_code`),
  CONSTRAINT `grades_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  CONSTRAINT `grades_ibfk_2` FOREIGN KEY (`course_code`, `dept_id`, `school_code`) REFERENCES `courses` (`course_code`, `dept_id`, `school_code`)
